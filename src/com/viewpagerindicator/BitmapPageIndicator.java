...
public class BitmapPageIndicator extends View implements PageIndicator {
    ...
    public BitmapPageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiUnderlinePageIndicatorStyle);
    }

    public BitmapPageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        int selectedDirection = a.getInteger(R.styleable.UnderlinePageIndicator_selectedDirection, 1);
        setSelectedDirection(selectedDirection);
        if(selectedDirection == 2){
        	setFades(false);
//        	setBackgroundColor(Color.parseColor("#40ccfa"));
        }
        a.recycle();
    ...
    /**
     * 设置显示的方向
     * @param selectedDirection 0 上面 1 居中 2 底部
     */
...
//        canvas.drawRect(left, top, right, bottom, mPaint);
        ...
        if(mSelectedDirection == 0){ //上面
        	if(mBitmap != null){
            	canvas.drawBitmap(mBitmap, left + pageWidth/2 - mBitmap.getWidth() / 2, top, mPaint);
            }
        }else if(mSelectedDirection == 1){ //居中
        	if(mBitmap != null){
            	canvas.drawBitmap(mBitmap, left + pageWidth/2 - mBitmap.getWidth() / 2, top, mPaint);
            }
        }else{ //底部
        	if(mBitmap != null){
            	canvas.drawBitmap(mBitmap, left + pageWidth/2 - mBitmap.getWidth() / 2, getHeight() -mBitmap.getHeight(), mPaint);
            }
        }
