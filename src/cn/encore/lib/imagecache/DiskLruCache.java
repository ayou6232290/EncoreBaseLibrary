...
public class DiskLruCache {
    ...
    public static DiskLruCache openCache(File cacheDir, long maxByteSize) {
        ...
        if (cacheDir.isDirectory() && cacheDir.canWrite() && ImageCacheUtils.getUsableSpace(cacheDir) > maxByteSize) {
     ...
     * 
     * @param key A unique identifier for the file.
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        final String cachePath = Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) || !ImageCacheUtils.isExternalStorageRemovable() ? ImageCacheUtils.getExternalCacheDir(context).getPath() : context.getCacheDir().getPath();
